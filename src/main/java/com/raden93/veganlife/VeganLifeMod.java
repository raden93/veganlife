...
import com.raden93.veganlife.registry.BlockManager;
import com.raden93.veganlife.registry.ItemManager;
...
public class VeganLifeMod {
    ...
    public VeganLifeMod() {
        ...
        BlockManager.BLOCKS.register(FMLJavaModLoadingContext.get().getModEventBus());
